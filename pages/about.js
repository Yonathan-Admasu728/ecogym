        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col items-center">
              <Image src="/images/workout.jpg" alt="Workout" width={640} height={360} className="w-full h-64 object-cover rounded-lg shadow-md" />
            ...
            <div className="flex flex-col items-center">
              <Image src="/images/meditation.jpg" alt="Meditation" width={640} height={360} className="w-full h-64 object-cover rounded-lg shadow-md" />
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col items-center">
              <Image src="/images/community.jpg" alt="Community" width={640} height={360} className="w-full h-64 object-cover rounded-lg shadow-md" />
            ...
            <div className="flex flex-col items-center">
              <Image src="/images/eco-friendly.jpg" alt="Eco-Friendly" width={640} height={360} className="w-full h-64 object-cover rounded-lg shadow-md" />
